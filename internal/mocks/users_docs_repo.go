...
// Insert provides a mock function with given fields: name
func (_m *UsersDocsRepo) Insert(name string) (domain.UserID, error) {
	ret := _m.Called(name)
...
//   - name string
func (_e *UsersDocsRepo_Expecter) Insert(name interface{}) *UsersDocsRepo_Insert_Call {
	return &UsersDocsRepo_Insert_Call{Call: _e.mock.On("Insert", name)}
}

func (_c *UsersDocsRepo_Insert_Call) Run(run func(name string)) *UsersDocsRepo_Insert_Call {
...
func (_c *UsersDocsRepo_Insert_Call) RunAndReturn(run func(string) (domain.UserID, error)) *UsersDocsRepo_Insert_Call {
	_c.Call.Return(run)
	return _c
}
